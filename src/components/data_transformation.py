...
class DataTransformationConfig:
    preprocessor_obj_file_path=os.pathjoin('artifacts',"preprocessor.pkl")
...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            logging.info(
                f"Applying preprocessing object on training and testin dataframe"
            )
